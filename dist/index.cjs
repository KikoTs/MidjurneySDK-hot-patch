...
var snowyflake = require('snowyflake');
...
const snowflake = new snowyflake.Snowyflake({
  workerId: 0n,
  processId: 0n,
  epoch: snowyflake?.Epoch?.Discord
});
...
exports.MidjourneyCommand = MidjourneyCommand;
exports.MidjourneyWs = MidjourneyWs;
